...
const OTPVerification = () => {
  ...
  const [phoneNumber] = useState("+919876543221");
      ...
      >
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.subHeading}>
            ...
            <Text style={styles.phone}>{getMaskedPhoneNumber(phoneNumber)}</Text>
          </Text>
