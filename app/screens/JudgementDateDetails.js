...
//     console.log("Judgement date",route.params);
...
//             console.log("getJudgementDateDetails", response);
...
export default function JudgementDateDetails({ route, navigation }) {
    ...
    const CourtFilterDigestView = async (courts, judges, benchStrength, Case_Results, Decision_Years, Nominal, nominalRes, topics, acts, section, searchInSearch, searchFilter) => {
        ...
        try {
            ...
            const response = await getJudgementDateDetails(decision_period, fromDate, toDate, 10, `${page}`, courts, judges,benchStrength, Case_Results, Decision_Years, Nominal, nominalRes, topics, acts, section, searchInSearch, searchFilter);
        ...
        <SafeAreaView edges={['left', 'right', 'bottom']} style={globalStyle.safearea}>
            <Background>
                ...
                <CustomModal
                    ...
                    data={{ ...(filterData || {}), decision_period }}
                />
